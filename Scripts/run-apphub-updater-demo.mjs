...
function resolveAppHub() {
  const macBundle = join(repoRoot, 'build', 'Apps', 'System', 'AppHub', 'AppHub.app', 'Contents', 'MacOS', 'AppHub');
  const plain = join(repoRoot, 'build', 'Apps', 'System', 'AppHub', process.platform === 'win32' ? 'AppHub.exe' : 'AppHub');
